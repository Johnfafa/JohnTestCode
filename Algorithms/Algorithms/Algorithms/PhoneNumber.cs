...
namespace Algorithms
{
    public class PhoneNumber
    {
        ...
        public IList<string> Combinations2(string digits)
        {
        ...
        public void Run()
        {
            ...
            var result = Combinations2(phoneNums);
            File.WriteAllLines(@"D:\Study\Timothy\Algorithm\Algorithms\Algorithms\Algorithms\phonenumbers2.txt",result);
        }
    }
}
